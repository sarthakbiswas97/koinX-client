export default function TeamCard() {
    return (
      <div className="w-700 h-700 bg-white rounded-xl mt-4 ml-14 mr-3">
        <div>
          <div className="text-2xl text-[#0F1629] font-semibold ml-4">Team</div>
          <div className="text-[#3E424A] text-[16px] font-medium ml-4 my-4 pt-2">
  ...
  function Card({ name, link, des }: any) {
    return (
      <div className="md:flex ml-4 mr-4 bg-[#E8F4FD] rounded-lg py-4 md:px-8 my-6">
