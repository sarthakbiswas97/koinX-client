function Tokenomics() {
    return (
      <div className="w-200 h-200 bg-white rounded-xl ml-14 mr-3">
        <div className="text-[#0F1629] text-2xl font-semibold ml-4">Tokenomics</div>
        <div className="my-6">
          <div className="text-[#1D1D1D] text-xl font-semibold ml-4">
            Initial Distribution
          </div>
          <div className="py-4 flex ml-4">
            <div>
              <svg
                width="179"
                height="180"
          ...
          <div className="text-[#3E424A] text-[16px] py-2 ml-4">
